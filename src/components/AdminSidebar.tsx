            ...
            <div className='w-full '>
				...
				<li className='py-3 px-1 mb-3'><Link href={'/category/list'} className='flex items-center justify-center'> <IoIosAddCircle className='mx-2' />Category List</Link></li>
				 ...
				 <li className='py-3 px-1 mb-3'><Link href={'/category/add-category'} className='flex items-center justify-center'> <IoIosAddCircle className='mx-2' /> Add Category</Link></li>
					...
					<li className='py-3 px-1 mb-3'><Link href={'/product/list'} className='flex items-center justify-center'> <IoIosAddCircle className='mx-2' /> Product List</Link></li>
					
					
                    <li className='py-3 px-1 mb-3'><Link href={'/order/create-order'} className='flex items-center justify-center'> <IoIosAddCircle className='mx-2' /> Add Order</Link></li>
					
				
					<li className='py-3 px-1 mb-3'><Link href={'/order/list'} className='flex items-center justify-center'> <IoIosAddCircle className='mx-2' /> Order List</Link></li>
